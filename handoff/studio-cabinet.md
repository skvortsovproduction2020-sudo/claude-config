...
**0. Протестировать КП с комментариями и стилем** (приоритет 1)
   - Зайти в Настройки → вписать стиль КП (как пишешь, что избегаешь)
   - Открыть переговоры → вкладка КП → вписать комментарии → нажать «Сгенерировать»
   - Проверить что стиль и комментарии отражены в результате
